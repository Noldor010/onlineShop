...
import { productsActions, searchFetch } from "../../redux";
...
const Search = () => {
  ...
  const {skipPage} = useSelector(state => state.products);
  // useCallback
  // eslint-disable-next-line
  const updateSearchValue = React.useCallback(
    debounce((str) => {
      dispatch(searchFetch({search:str, skip:skipPage}));
    }, 250),
    []
  );
  // handlers
